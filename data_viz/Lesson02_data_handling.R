...
with(pop, pie(pop.a18, labels=label2, col=rainbow(length(area)), main="2018년 권역별 인구 비율"))
...
par(mfrow=c(1:2))
with(pop, pie(grdp.a10, labels=labell1, col=rainbow(length(area)), main="2010년 권역별 grdp"))
with(pop, pie(grdp.a18, labels=labell2, col=rainbow(length(area)), main="2018년 권역별 grdp"))
#권역별  grdp - (교수님)
